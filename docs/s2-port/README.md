...
networks/s2-big/      # 6-node OSPF line with 197 prefixes (query-sharding measurement)
networks/s2-big-bgp/  # 6-node eBGP line with 192 prefixes (control-plane prefix-sharding measurement)
